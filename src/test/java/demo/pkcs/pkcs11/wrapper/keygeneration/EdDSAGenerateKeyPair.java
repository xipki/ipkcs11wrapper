...
public class EdDSAGenerateKeyPair extends TestBase {
  ...
  private void main0(Token token, Session session) throws TokenException {
    ...
    if (supportedMechanisms.contains(Mechanism.get(PKCS11Constants.CKM_EDDSA))) {
      signatureMechanismInfo = token.getMechanismInfo(Mechanism.get(PKCS11Constants.CKM_EDDSA));
    } else {
