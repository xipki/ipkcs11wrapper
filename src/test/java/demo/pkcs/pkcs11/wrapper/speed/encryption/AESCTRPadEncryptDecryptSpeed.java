 ...
 * @author Lijun Liao
 */
public class AESCTRPadEncryptDecryptSpeed extends TestBase {
  ...
  private static final long encryptMechanism = CKM_AES_CTR;
  ...
  public AESCTRPadEncryptDecryptSpeed() {
    iv = randomBytes(16);
  }
  ...
  private AttributeVector getMinimalKeyTemplate0() {
    return newSecretKey(CKK_AES).attr(CKA_VALUE_LEN, keyLen / 8);
  }
